...
const JSCookies = () => {
  ...
  return (
    <div className="max-w-4xl p-6 mt-10">
     ...
     <h1 className="text-2xl text-gray-800 font-semibold mt-10 mb-3">Create a Cookie with JavaScript</h1>
    ...
    <h1 className="text-2xl text-gray-800 font-semibold mt-10 mb-3">Read a Cookie with JavaScript</h1>
    ...
    <h1 className="text-green-400 bg-gray-900 p-4 rounded-lg mt-5 mb-3">Change a Cookie with JavaScript</h1>
  ...
  <h1 className="text-2xl text-gray-800 font-semibold mt-10 mb-3">Delete a Cookie with JavaScript</h1>
