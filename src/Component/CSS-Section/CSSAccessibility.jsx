...
const AccessibleCard = () => {
  return (
    <div className="p-6 font-sans max-w-4xl mt-10">
      ...
      <div className="bg-gray-900 text-green-400 rounded-lg p-4 overflow-x-auto max-w-full whitespace-pre-wrap mt-5">
        <pre>
          {`body {
  ...
  color: #000000;
      ...
      <div className="bg-gray-900 text-green-400 p-4 rounded-lg overflow-x-auto max-w-full whitespace-pre-wrap mt-5">
        <pre>
          {`   body {
      ...
      <div className="bg-gray-900 text-green-400 rounded-lg p-4 overflow-x-auto max-w-full whitespace-pre-wrap mt-3">
        <pre>
