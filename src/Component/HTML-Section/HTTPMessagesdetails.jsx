...
const HttpsMessages = () => {
  return (
    <div className="p-4 sm:p-6 bg-white rounded-lg shadow-md max-w-4xl">
      <h1 className="text-2xl font-bold mb-4">HTTPS Messages</h1>
      <p className="mb-4">
      ...
      {/* Request Message */}
      <h2 className="text-xl font-semibold mt-6 mb-2">1. HTTPS Request Message</h2>
      <p className="mb-2">
...
Accept: text/html`}
      ...
      {/* Response Message */}
      <h2 className="text-xl font-semibold mt-6 mb-2">2. HTTPS Response Message</h2>
      <p className="mb-2">
