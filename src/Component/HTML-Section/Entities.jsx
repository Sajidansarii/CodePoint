...
const HTMLEntities = () => {
  return (
    <div className="p-4 sm:p-6 md:p-8 max-w-4xl">
      {/* Title */}
      <h1 className="text-3xl font-medium text-blue-500 mb-3">HTML Entities</h1>

      {/* Intro */}
      <p className="leading-relaxed mb-3">HTML entities are special codes used to represent characters that either have special meaning in HTML or are not easily typed. They ensure those characters display correctly in the browser.</p>

      {/* Why Use Entities */}
      <section className="mb-6">
        <h2 className="text-2xl font-semibold text-blue-500 mb-3">Why Use HTML Entities?</h2>
      ...
      {/* Examples */}
      <section className="mb-6">
        <h2 className="text-2xl font-semibold text-blue-500 mb-3">Common Examples</h2>
...
&nbsp; → (non-breaking space)`}
      ...
      {/* Named vs Numeric */}
      <section className="mb-6">
        <h2 className="text-2xl font-semibold text-blue-500 mb-3">Named vs Numeric Entities</h2>
        <p className="text-gray-700 mb-3">There are two formats:</p>
      ...
      {/* Use Cases & Tips */}
      <section className="mb-6">
        <h2 className="text-2xl font-semibold text-blue-500 mb-3">Use Cases & Tips</h2>
        <ul className="list-[square] list-inside space-y-1 text-gray-700">
