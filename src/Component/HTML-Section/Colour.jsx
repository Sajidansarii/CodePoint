const HTMLColors = () => {
  return (
    <div className="p-4 sm:p-6 md:p-8 max-w-4xl">
      {/* Title */}
      <h1 className="text-3xl font-semibold text-blue-500 mb-3">HTML Colors</h1>

      {/* Intro */}
      <p className="leading-relaxed mb-3">HTML colors are used to set the foreground (text), background, borders, and other visual elements on a web page. Colors in HTML can be defined using names, HEX codes, RGB, RGBA, HSL, or HSLA values.</p>

      {/* Color Names */}
      <section className="mb-6">
        <h2 className="text-2xl font-semibold text-blue-500 mb-3">1. Color Names</h2>
...
<p style="background-color: hsla(120, 100%, 50%, 0.3);">Semi-transparent green background</p>`}</code>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-5 space-y-1 leading-relaxed">
          <l3>Ensure sufficient contrast between text and background for readability.</l3>
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-md border border-blue-200">
        ...
        <ul className="list-disc pl-5 space-y-1 leading-relaxed text-s3 sm:text-base">
